...
import { collectionFilmsRef, collectionSeriesRef } from "./lib/firebase-config";
...
export const SetMovieDataOnce = async () => {
  await addDoc(collectionSeriesRef, {
    title: "Tiger King",
    description:
  ...
  //Films Collection
  await addDoc(collectionFilmsRef, {
    title: 'The Prestige',
    description:
